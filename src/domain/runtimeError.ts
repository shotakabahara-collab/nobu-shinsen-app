...
export function classifyRuntimeError(error:unknown):RuntimeErrorInfo{
 ...
 if(has('stop_unit_type_limit','兵種戦法は1枚まで'))return {code:'DATA-003',title:'兵種戦法の組み合わせを確認してください',message:'兵種戦法は1編成につき1つまでです。2つ以上の兵種戦法が装着されています。',guidance:['編成編集で、兵種戦法を1つだけ残してください。','「僧兵」と「鉄砲僧兵」を同時に装着している場合は、編成兵種に合う方だけを残してください。'],detail,retryable:false};
 if(has('stop_formation_limit','陣形戦法は1枚まで'))return {code:'DATA-003',title:'陣形戦法の組み合わせを確認してください',message:'陣形戦法は1編成につき1つまでです。2つ以上の陣形戦法が装着されています。',guidance:['編成編集で、陣形戦法を1つだけ残してください。'],detail,retryable:false};
 if(has('stop_unit_type_mismatch','兵種条件を満たさない'))return {code:'DATA-003',title:'戦法と兵種を確認してください',message:'編成兵種と、装着戦法が使用できる兵種が一致していません。',guidance:['編成の兵種を確認してください。','その兵種で使用できる戦法へ変更してください。'],detail,retryable:false};
