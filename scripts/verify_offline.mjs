...
console.log(`offline precache verified: ${required.length} required assets; canonical simulate_once 50+50 battles streamed through one Pyodide worker with compact T1-T8 examples and structured Safari errors; ${officerCatalog.officerCount} canonical officers; ${officerStats.recordCount} officer/awaken stat rows; ${skillCatalog.skillCount} canonical skills; runtime bundle ${bundleSha}`);
