...
const required=['pyodide/pyodide.js','pyodide/pyodide.asm.js','pyodide/pyodide.asm.wasm','pyodide/pyodide-lock.json','pyodide/python_stdlib.zip','runtime-worker.js','runtime_bundle_b223.tgz','manifest.webmanifest','apple-touch-icon.png','icon-192.png','icon-512.png'];
...
console.log(`offline precache verified: ${required.length} required assets; runtime bundle ${bundleSha}`);
